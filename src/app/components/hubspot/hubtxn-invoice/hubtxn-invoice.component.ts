...
@Component({
  selector: 'app-hubtxn-invoice',
  templateUrl: './hubtxn-invoice.component.html',
  styleUrls: ['./hubtxn-invoice.component.scss']
})
export class HubtxnInvoiceComponent implements OnInit {
