...
@Component({
  selector: 'app-hubtxn-customer',
  templateUrl: './hubtxn-customer.component.html',
  styleUrls: ['./hubtxn-customer.component.scss']
})
export class HubtxnCustomerComponent implements OnInit {
